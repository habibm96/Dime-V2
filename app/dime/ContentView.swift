...
struct ContentView: View {
    ...
    @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var colourScheme: Int = 0
    @Environment(\.scenePhase) var scenePhase
    @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var showNotifications: Bool = false
    @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var notificationsEnabled: Bool = true

    @AppStorage("firstLaunch", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var firstLaunch: Bool = true

    // adds category orders
    @AppStorage("dataMigration1", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var dataMigration1: Bool = true
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var savedTopEdge: Double = 30
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var savedBottomEdge: Double = 15

    // updateSheetShowing

    @AppStorage("previousVersion", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var previousVersionString: String = "Version \(UIApplication.appVersion ?? "") (\(UIApplication.buildNumber ?? ""))"

    @AppStorage("showUpdateSheet", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var showUpdateSheet: Bool = true
    ...
    var body: some View {
        ...
        .onAppear {
//            UserDefaults(suiteName: "group.com.habibm96.stash")!.set(false, forKey: "newTransactionAdded")
//            WidgetCenter.shared.reloadTimelines(ofKind: "TemplateTransactions")
            ...
            let defaults =
                UserDefaults(suiteName: "group.com.habibm96.stash") ?? UserDefaults.standard
