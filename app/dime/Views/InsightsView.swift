...
struct InsightsView: View {
    ...
    @AppStorage("chartTimeFrame", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var chartType = 1
...
struct SingleGraphView: View {
    ...
    @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var incomeTracking: Bool = true
...
//        return abs(offset) > UIScreen.main.bounds.width * 0.3
    ...
    @AppStorage("insightsViewIncomeFiltering", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var income: Bool = true
    @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var incomeTracking: Bool = true
...
//    @AppStorage("animated", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var animated: Bool = true
