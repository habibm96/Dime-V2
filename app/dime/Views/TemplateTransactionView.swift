...
struct TemplateTransactionView: View {
    ...
    @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var numberEntryType: Int = 1

    @Environment(\.colorScheme) var colorScheme

    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var topEdge: Double = 30
