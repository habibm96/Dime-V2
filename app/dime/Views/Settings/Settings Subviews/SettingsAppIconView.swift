...
struct SettingsAppIconView: View {
  ...
  let options: [AppIconBundle] = [
    ...
    AppIconBundle(
      ...
      displaySubtitle: "Stash definitely isn't becoming one but it never hurts to keep dreaming."),
    AppIconBundle(
    ...
    AppIconBundle(
      ...
      displaySubtitle: "Haphazardly put together in under 30 minutes, the original Stash icon.")
  ]
