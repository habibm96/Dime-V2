...
struct SettingsView: View {
  ...
  @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  ...
  @AppStorage("activeIcon", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  ...
  @AppStorage("firstWeekday", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  ...
  @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  var showNotifications: Bool = false
  @AppStorage("notificationOption", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  var option: Int = 1
  ...
  @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  ...
  @AppStorage("showCents", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  var showCents: Bool = true

  @AppStorage("animated", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var animated:
    Bool = true

  @AppStorage("currency", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var currency:
    String = Locale.current.currencyCode!

  @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  var incomeTracking: Bool = true
    
  @AppStorage("showExpenseOrIncomeSign", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  var showExpenseOrIncomeSign: Bool = true

  @AppStorage(
    "showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
  ...
  var upcomingString: String {
    ...
    @AppStorage("haptics", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
...
struct TipJarAlert: View {
  ...
  @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.habibm96.stash"))
...
struct ProductView: View {
  ...
  func getText(_ string: String) -> String {
    if string == "com.habibm96.stash.smalltip" {
      return String(localized: "☕ Coffee-Sized Tip")
    } else if string == "com.habibm96.stash.mediumtip" {
      return String(localized: "🌮 Taco-Sized Tip")
    } else if string == "com.habibm96.stash.largetip" {
