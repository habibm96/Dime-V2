...
struct LogView: View {
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsTimeFrame", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var timeframe = 2
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var lineGraph: Bool = false
    ...
    var range: Int {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.habibm96.stash")?.integer(forKey: "firstWeekday") ?? 0
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var showSoon: Bool = false
...
struct ListView: View {
    ...
    @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var swapTimeLabel: Bool = false
...
struct DeleteTransactionAlert: View {
    ...
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.habibm96.stash")) var bottomEdge: Double = 15
